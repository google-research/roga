        ...
        for query in &[query1, query2] {
            ...
            match action {
                ...
                1 | 2 => {
                    ...
                    expected.entry(query.clone()).or_default().copy_from_slice(new_val.as_slice());
                }
                3 | 4 => {
                ...
                5 => {
                    ...
                    omap.access(query, |result_code, val| match expected.entry(query.clone()) {
                        Entry::Vacant(_) => {
                            assert_eq!(result_code, OMAP_NOT_FOUND);
                        }
    ...
    O: ObliviousHashMap<KeySize, ValSize>,
{
    ...
    loop {
        ...
        if result_code == OMAP_FOUND {
            ...
            assert_eq!(omap.len(), idx - 1, "omap.len() unexpected value after overflow");
        ...
        for query in &[query1, query2] {
            ...
            let result_code = omap.access_and_insert(query, &zero, rng, |_status_code, buffer| {
                ...
                *buffer = Aligned(num.to_ne_bytes().into());
                ...
                expected.entry(query.clone()).or_default().copy_from_slice(buffer);
            });
