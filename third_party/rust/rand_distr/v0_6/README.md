...
-   All closed Issues and merged Pull requests from before 5.February.2025
    (version 0.5.0) can be found in the
    [rand](https://github.com/rust-random/rand) repository where this crate used
    to be.
