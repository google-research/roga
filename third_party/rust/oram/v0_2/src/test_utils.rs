...
pub(crate) fn init_logger() {
    INIT.call_once(|| {
        WriteLogger::init(log::LevelFilter::Error, Config::default(), std::io::stdout()).unwrap()
    })
}
    ...
    Standard: Distribution<T::V>,
{
    ...
    for _ in 0..num_operations {
        ...
        let random_block_value = rng.r#gen::<T::V>();

        let read_versus_write = rng.r#gen::<bool>();
        ...
        if read_versus_write {
            ...
            oram.write(random_index, random_block_value, &mut rng).unwrap();
    ...
    Standard: Distribution<T::V>,
{
    ...
    for _ in 0..num_passes {
        for index in 0..capacity {
            ...
            let read_versus_write: bool = rng.r#gen::<bool>();
