...
OHashBase<KeyType, BlockSize>* determine_hash(
    KeyType n = 1, KeyType op_num = 1, KeyType delta_inv_log2 = DELTA_INV_LOG2);
...
class ObliviousBin {
 ...
 public:
  ObliviousBin(KeyType n = 1, KeyType op_num = 1,
      ...
      : n(n),
        hash(determine_hash<KeyType, BlockSize>(n, op_num, delta_inv_log2)),
        _empty(true) {}
  ...
  inline std::vector<Block<KeyType, BlockSize>>& data() { return hash->data(); }
